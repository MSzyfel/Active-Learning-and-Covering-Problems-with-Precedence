...
\newcommand{\ProblemPCDT}{\textsc{PCDT}}
...
\title[Optimal Decision Trees and Covering Problems with Precedence]{Optimal Decision Trees and Covering Problems with Precedence}
\usepackage{times}
