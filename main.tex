...
\begin{abstract}%
  ...
  In the covering problems, we are given a set of items and a collection of subsets  that cover these items. The objective is to select a sequence of tests that covers all items which again, minimized the worst or average covering cost.
