...
\end{tikzpicture}
\caption*{(a) Universe and covering sets}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
\centering
...
\node[set, fill=yellow!70!red!30] (s8) at (-1,-1.5) {$S_8$};
\node[set, fill=magenta!30] (s7) at (1.5,-3) {$S_7$};
\node[set, fill=purple!30] (s5) at (0.5,-4.5) {$S_5$};

% Component with S3 (right top)
\node[set, fill=green!30] (s3) at (3,0) {$S_3$};
\node[set, fill=red!30] (s1) at (2.5,-1.5) {$S_1$};
\node[set, fill=orange!30] (s4) at (3.5,-1.5) {$S_4$};

% Component with S2 (right bottom)
\node[set, fill=blue!30] (s2) at (3,-3) {$S_2$};
\node[set, fill=teal!30] (s9) at (3,-4.5) {$S_9$};
...
\node[element] at (4.6, 4.5) {};
\node[element] at (4.7, 3.9) {};
\node[element] at (4.1, 3.4) {};

\node[element] at (0, 2.8) {};
\node[element] at (1.1, 2.55) {};
\node[element] at (0.8, 2.0) {};
\node[element] at (0.2, 1.6) {};
...
\end{tikzpicture}
\caption*{(c) Solution: selected sets $\{S_1, S_2, S_6, S_8, S_9\}$ (in color)}
\end{minipage}
