...
We say that an algoritm is $(\gamma,\alpha)$-approximation for $\ProblemPCSC$ if for any input instance $\cI=(\cU,\cS,\preceq,k)$ it returns a solution $\cC$ that covers at least $\alpha k$ items and $\spr{\cC}\leq\gamma\cdot\optPCSC{\cI}$.
