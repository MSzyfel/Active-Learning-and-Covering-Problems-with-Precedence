...
Suppose that an active learning strategy performed some tests $T\subseteq\cT$.
...
\medskip
We finish this section with two monotonicity properties that apply both to $\ProblemPCACAL$ and $\ProblemPCWCAL$.
