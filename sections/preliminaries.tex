...
The criteria we consider for any $\ProblemPCDT$ instance $I$ are denoted by
$$\OPTA\br{\cI}=\min\brc{\COSTA\br{D} \mid D\textup{ is a decision tree}},$$
$$\OPTW\br{\cI}=\min\brc{\COSTW\br{D} \mid D\textup{ is a decision tree}}.$$
Hence the $\ProblemPCACDT$ aims at finding a decision tree $D$ such that $\COSTA\br{D}=\OPTA\br{\cI}$ and in case of $\ProblemPCWCDT$ the goal is to find $D$ such that $\COSTW\br{D}=\OPTW\br{\cI}$.
For $X\subseteq\cH$, $p(X)=\sum_{x\in X}p(x)$.

\DD{ponizsze do przeformulowania...}
...
% \begin{definition}[Precedence constrained worst case decision tree (PCWCDT)]
...
% \end{definition}
% \begin{definition}[Precedence constrained average case decision tree (PCACDT)]
