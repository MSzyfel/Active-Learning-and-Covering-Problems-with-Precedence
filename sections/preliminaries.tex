...
\begin{itemize}
 ...
 \item proponuje, aby wszelkie parametry byly komendami latex ($OPT_*, COST_*, cov()$, nazwy problemow (to juz wprowadzilem). Czyli nazwijmy to wszystko jako zmienne globalne. Ja to pewnie zrobie w kolejnej rundzie, a tylko zaznaczam, aby pozniej sie tego trzymac. (Zalety te same co w kodowaniu z identyfikatorami stalych vs stale zaszyte w kodzie.)
\end{itemize}
}
