...
\begin{theorem}\label{thm:PCWCAL-NP-hard}
...
\begin{theorem}\label{thm:PCACAL-APX-hard}
...
\begin{theorem}\label{thm:PCSC-to-PCWCAL-hardness}
...
\begin{theorem}\label{thm:PCWCAL-outforest-hardness}
...
\begin{theorem}\label{thm:PCACAL-PDS-hardness}
...
\begin{theorem}\label{thm:PCWCAL-PDS-hardness}
