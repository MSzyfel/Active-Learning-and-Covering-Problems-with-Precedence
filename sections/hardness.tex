...
% 	\end{figure}
	...
	\paragaraph{YES case:} Assume that the instance of $(C, V)$ \ProblemThreeSat is of 'YES' type.
	Hence let $f: V \leftarrow \{T, F\}$ be an evaluation which satisfies all the clauses.
