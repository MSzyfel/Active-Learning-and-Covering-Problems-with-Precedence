...
\begin{lemma}\label{lemma:optimal_half_cut}
...
Consequently, one can easily compute such a cut in polynomial time by checking all possible candidates. We also have the following lemma relating the size of the optimal cut with the cost of the optimal decision tree:
...
\begin{theorem}\label{thm:binary-search-approximation}
