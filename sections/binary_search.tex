...
\begin{theorem}\label{thm:binary-search-approximation}
    The above algorithm is an $O\br{\log n}$-approximation for the $\ProblemPCACAL$ in the case of binary search with precedence constraints.
\end{theorem}
\begin{proof}
