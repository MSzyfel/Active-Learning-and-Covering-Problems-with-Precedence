...
\begin{proof}
    ...
    Let $l^*$ be the value of $l$ such that $a^{l^*-1} < \spr{\zeta^*} \leq a^{l^*}$.  We start with the following lemma.
    \begin{lemma}\label{lem:pi-spread-cost}
        We have that $\spr{\pi_{l^*}} = \Theta\br{\alpha \cdot \beta}\cdot \spr{\zeta^*}$ and $\COST\br{\pi_{l^*}} = \cO\br{\alpha\cdot\beta^3}\cdot \COST\br{\zeta^*}$.
    \end{lemma}
    \begin{proof}
        ...
        $$
        \spr{\pi_{l^*}} \leq \alpha\cdot \sum_{i=1}^{l^*} a^{i+1}\leq \frac{\alpha\cdot a^{l^*+2}}{a-1}\leq \frac{\alpha\cdot a^{3}\spr{\zeta^*}}{a-1}\leq8\alpha\cdot \br{3\beta-1}\cdot\spr{\zeta^*}
        $$
