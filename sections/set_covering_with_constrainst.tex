...
\end{lemma}
\begin{proof}
    \MS{Idea jest taka: pokazujemy za pomocą szeregu harmonicznego, że jesli dodajemy zbiory do momentu az pokryjemy optymalna liczbe elementow, to koszt czegos takiego bedzie nie wiekszy niz $H_n\cdot B$ ponieważ na każdym etapie mamy $B$-aproksymacje do $\ProblemBMDPCS$. Przez to, że w naszym algorytmie zatrzymujemy sie dopiero gdy koszt przekroczy $\sqrt{m\cdot H_n}\cdot B$, to znaczy, że pokryliśmy co najmniej optymalna liczbe elementow.}
\end{proof}
\end{proof}
