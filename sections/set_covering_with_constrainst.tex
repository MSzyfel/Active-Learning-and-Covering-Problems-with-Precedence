...
\begin{proof}
 Let $\cA^*$ be an optimal solution consisting of sets $S_1, \ldots, S_k$ and let $\cA$ be a greedy solution (cf. Section~\ref{sec:MDPCS}).
 Define $\delta = \max_{S \in \mathcal{G}} \Delta\br{\closure{S}}$.
 There are two cases:
\begin{enumerate}
