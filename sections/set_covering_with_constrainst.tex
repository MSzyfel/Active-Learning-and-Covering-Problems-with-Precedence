...
\begin{theorem}
    ...
    $$
    \cA=\argmax_{S \in \mathcal{G}, \spr{\closure{S}}\leq B} \brc{\Delta\br{\closure{S}, \cU}}.
    $$ 
...
\begin{proof}
    ...
    $$
    \spr{\cov\br{\cA^*, \cU}} \leq \sum_{i=1}^{k}\spr{\cov\br{\closure{S_i}, \cU}}\leq \delta_B\sum_{i=1}^k \spr{\closure{S_i}} \leq \delta_B \cdot k^2
    $$
