...
Section~\ref{sec:preliminaries} introduces necessary preliminaries. Section \ref{sec:AL} presents our approximation algorithms for decision trees, relying on approximation algorithms for set covering developed in Section~\ref{sec:SC}. Section~\ref{sec:hardness} provides our hardness results for both decision tree and set covering.
