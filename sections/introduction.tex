...
\midrule
none & $\br{1, \frac{e}{e-1}}$ \cite{TheBudgetedMaximumCoverageProblem} & $\br{1, \frac{e}{e-1}}$ \cite{TheBudgetedMaximumCoverageProblem} & $\br{\frac{4e}{e-1},1}$ \cite{EfficientSequencesOfTrials} & $\cO(\log n)$ \cite{DiagnosisDetermination} & $\cO(\log n)$ \cite{DiagnosisDetermination} \\
\cdashline{2-6}
