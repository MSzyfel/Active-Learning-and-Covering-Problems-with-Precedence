...
The \emph{density} $\Delta$ of a nonempty subfamily $\mathcal{A}$ on an universum $X$ ($A\subseteq X$ for each $A\in\mathcal{A}$) is
\[
\Delta\br{\mathcal{A}, X} \equiv \frac{\spr{\bigcup\mathcal{A}\cap X}}{\spr{\mathcal{A}}}
\]
