...
general & $\br{\sqrt{m \cdot H_n}+1, 1}$ (Thm.~\ref{thm:BPCSC})* & $\br{\cO(\sqrt{m}/f), 2}$ (Thm.~\ref{thm:MDPCStoPCSC}), $\br{\sqrt{m \cdot H_n}+1, 1}$ (Cor.~\ref{cor:BPCSC-to-PCSC})* & $(\sqrt{m \cdot H_n}+1, 1)$ (Thm.~\ref{thm:BPCSC-to-PCMSSC})* & $\cO(\sqrt{m}\log n)$ (Thm.~\ref{thm:alphaPCWCDT})* & $\cO(\sqrt{m}\log^{3/2}\!n)$ (Cor.~\ref{cor:PCACDT-special-cases})* \\
\bottomrule
\end{tabular}
}
\end{table}
