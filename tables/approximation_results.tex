\begin{table}[ht!]
\caption{Approximation guarantees for covering and decision tree problems under different precedence constraints. (* denotes new results, \DD{** denotes previously unmentioned corollaries of known results)}.}
\label{tab:results}
\centering
{
\footnotesize
